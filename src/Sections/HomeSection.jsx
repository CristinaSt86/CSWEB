...
const HomeSection = () => {
  ...
  return (
    <section
      id="home"
      className="
    relative min-h-[100svh] flex items-center justify-center text-white text-center overflow-hidden
    bg-hero-mobile
    sm:bg-hero-tablet
    lg:bg-hero-desktop
    bg-cover bg-center
    ...
    >
      ...
      <div className="flex flex-col md:gap-6 py-6">
        <div className="md:bg-black/50 text-custom-textMenu md:text-white w-full max-w-6xl lg:max-w-5xl px-8 py-4 pt-48 md:pt-12 rounded">
          ...
          <h2
            className="text-xl font-semibold md:font-normal sm:text-xl md:text-3xl leading-relaxed mb-8"
            itemProp="description"
          >
            {t("home.subtitle")}
          </h2>
